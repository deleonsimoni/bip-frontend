...
@Component({
  selector: 'app-comparar-arquivos-dashboard',
  templateUrl: './comparar-arquivos-dashboard.component.html',
  styleUrls: ['./comparar-arquivos-dashboard.component.scss']
})
export class CompararArquivosDashboardComponent implements OnInit {
